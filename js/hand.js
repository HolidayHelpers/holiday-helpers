...
new HandItems('../img/hand/pet-a-dog.jpg', 'Pet a Dog', 'Do you have a nice, calm dog that may want some additional pets or treats? It’s been proven that petting an animal has calming effects on humans. If you’re willing to share your canine companion, there is guaranteed to be someone wanting their soft attention. This is a low activity, allow thirty minutes or more.');
...
new HandItems('../img/hand/take-a-walk.png', 'Take a Walk', 'It’s good to get out and take a walk, it’s even better to share a stroll with a friend. This is an active activity, sign up to take a walk with someone who would like to get out of the house and explore the neighborhood or local park. This activity could take thirty minutes or more.');
